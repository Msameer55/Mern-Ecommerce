...
const sendOTPEmail = async (email, otp) => {
  const data = {
    ...
    htmlContent: `
            <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;padding:32px;border:1px solid #e5e7eb;border-radius:12px;">
                ...
                <div style="font-size:36px;font-weight:700;letter-spacing:8px;color:#111827;text-align:center;padding:24px 0;">
                    ${otp}
                </div>
                <p style="color:#9ca3af;font-size:13px;">If you did not create an account, ignore this email.</p>
            </div>
        `,
  };
  ...
  console.log("✅ OTP sent via Brevo API:", response.data);
};
...
=======
  ...
  const data = {
    ...
    htmlContent: `
      <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;padding:32px;border:1px solid #e5e7eb;border-radius:12px;">
        ...
        <a href="${resetLink}"
           style="display:inline-block;background:#111827;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-weight:600;margin:16px 0;">
           Reset Password
        </a>
  ...
  console.log("✅ Reset password email sent via Brevo:", response.data);
>>>>>>> da0c1fc (new-changes)
};
...
export const register = async (req, res) => {
  ...
  try {
    ...
    // Try sending email and fail registration if SMTP is not working
    try {
...
export const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      console.error("Forgot Password Email Error:", error.response?.data || error.message);
      return res.status(500).json({
        success: false,
