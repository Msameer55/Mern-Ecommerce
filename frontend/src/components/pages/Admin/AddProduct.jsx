...
import { adminCreateProduct } from "../../../redux/slice/adminProductSlice";
...
const AddProduct = () => {
  ...
  const [form, setForm] = useState({
    ...
    material: "",
    gender: "",
    images: [], // Will store URLs after upload
  });
  ...
  const [imageFiles, setImageFiles] = useState([]); // Temporary storage for files before upload
  const [imagePreviews, setImagePreviews] = useState([]); // Store object URLs for preview
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await dispatch(adminCreateProduct(productData)).unwrap();
  ...
  return (
    <div className="p-6">
      ...
      >
        ...
        <textarea
          name="description"
          placeholder="This T-Shirt is made of 100% cotton and is machine washable."
